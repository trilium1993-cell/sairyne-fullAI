...
interface BackToProjectsConfirmationProps {
  isVisible: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export const BackToProjectsConfirmation: React.FC<BackToProjectsConfirmationProps> = ({
  isVisible,
  onClose,
  onConfirm
}) => {
        ...
        >
          ...
          <div className="flex gap-3 w-full mt-2">
            ...
            <button
              ...
              aria-label="Yes, return to projects"
            >
              <span className="[font-family:'DM_Sans',Helvetica] font-normal text-white text-[13px] tracking-[0] leading-[22px]">
                Yes, return
              </span>
